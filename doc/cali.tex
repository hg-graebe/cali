...
%       H.-G. Graebe | Univ. Leipzig | Version 2.2 
...
\vfill
\begin{quote}
The CALI package contains algorithms for computations in commutative algebra
closely related to the {\gr} algorithm for ideals and modules that were
developed until 1995.  

The package is no more under active development since 1995.  It can be used
and developed further under the terms of the GNU Public License.
\end{quote}
\vskip2em
